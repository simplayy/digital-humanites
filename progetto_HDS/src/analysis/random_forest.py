...
def prepare_data(df: pd.DataFrame, 
    ...
    if feature_cols is None:
        ...
        # Esclude gli identificatori e reaction_index che potrebbero causare overfitting
        feature_cols = [col for col in feature_cols if col not in ['thread_id', 'tweet_id', 'reaction_index']]
    else:
